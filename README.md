...
O projeto utiliza a arquitetura em MVC do própio Laravel, separando responsabilidades entre rotas, controllers, models, views, requests, policies e migrations.
